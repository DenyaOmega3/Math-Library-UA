...
\begin{example}
Зокрема з попереденього прикладу $\{0,1,2,3\}$ утворюють повну систему лишків за $\!\! \pmod 4$. Але можна взяти інші: $\{4,6,7,9\}$ або $\{-2,-1,0,1\}$.
\end{example}

\begin{proposition}
Справедливі наступне:
\begin{enumerate}[nosep,wide=0pt,label={\arabic*)}]
\item Нехай $a \equiv b \pmod n,\ c \equiv d \pmod n$. Тоді $a + c \equiv b + d \pmod n$;
\item Нехай $a \equiv b \pmod n,\ c \equiv d \pmod n$. Тоді $ac \equiv bc \pmod n$;
\item Нехай $a \equiv b \pmod n$, а також $d \mid n$. Тоді $a \equiv b \pmod d$;
\item Нехай $a \equiv b \pmod n$, а також $c \in \mathbb{N}$. Тоді $ac \equiv bc \pmod {nc}$;
\item Нехай $a \equiv b \pmod n$. Тоді $a^m \equiv b^m \pmod n, m \in \mathbb{N}$;
\item Нехай $ad \equiv bd \pmod n$ та $\gcd(d,n) = 1$. Тоді $a \equiv b \pmod n$.
\item Нехай $a \equiv b \pmod c$ та $a \equiv b \pmod d$. Тоді $a \equiv b \pmod {\lcm(c,d)}$.
\end{enumerate}
...
\begin{remark}
Про останню властивість. Для ділення обох частин умова $\gcd(d,n) = 1$ є важливою. Зокрема $2 \cdot 3 \equiv 2 \cdot 18 \pmod {10}$, але в жодному разі з цього НЕ випливає, що $3 \equiv 18 \pmod {10}$.
\end{remark}
...
Зараз наведу деякі (доволі важливі!) приклади про квадрати та куби цілих чисел.
...
\begin{example}
Довести, що $(2k+1)^2 \equiv 1 \pmod 8$ для будь-якого $k \in \mathbb{Z}$ (ліворуч непарне число).\\
...
\begin{theorem}
Нехай $b > 1$ -- ціле та $N \in \mathbb{N}$. Тоді число $N$ розкладається єдиним так:
\begin{equation}
