...
Коротше, хотілось би, щоб існувала куля $B(r;0) \subset \overline{A(B(0;1))}$. Наразі відомо лише, що $B(v_0;4r) \subset \overline{A(B(0;1))}$. Оберемо допоміжну точку $v_1 \in A(B(0;1))$, для якої $\| v_0 - v_1 \| < 2r$ (\textit{таке можливо зробити в силу замкненості, якщо взяти послідовність, яка прямує до $v_0$}). Тоді маємо тепер вкладення $B(v_1;2r) \subset \overline{A(B(0;1))}$.\\
Тепер нехай $v \in B(0;r)$, тоді дивна точка $\dfrac{1}{2} (2v + v_1) \in \dfrac{1}{2}B(v;2r)$. Оскільки $v_1 \in A(B(0;1))$, тобто $v_1 = A(u_1)$ для деякого $u_1 \in B(0;1)$, то запишемо точку $v$ у вигляді
\[
v = - A\left( \dfrac{u_1}{2}\right) + \dfrac{1}{2} (2v + v_1).
\]
Отже, $v \in -A\left (\dfrac{u_1}{2} \right) + \dfrac{1}{2} \overline{A\left(B\left(0; \dfrac{1}{2}\right)\right)} \overset{A \text{ --- лінійний}}{=} \overline{A\left( -\dfrac{u_1}{2} + B\left(0; \dfrac{1}{2}\right)\right)}$.\\
Нарешті, оскільки $u_1 \in B(0;1)$, тобто $\| u_1 \| < 1$, то звідси тоді $\overline{A\left( -\dfrac{u_1}{2} + B\left(0; \dfrac{1}{2}\right)\right)} \subset \overline{A(B(0;1))}$. Отже, ми довели, що $B(r;0) \subset \overline{A(B(0;1))}$.
\bigskip \\
...
\]
Нехай $v \in B\left( 0; \dfrac{r}{2} \right)$, тобто $\| v \| < \dfrac{r}{2}$, але тоді із того зауваження отримуємо $v \in \overline{A\left( B \left( 0;\dfrac{1}{2} \right) \right)}$. Значить, існує точка $b_1 \in B\left( 0;\dfrac{1}{2} \right)$, для якої $\| v - Ab_1 \| < \dfrac{r}{4}$ (\textit{це можливо за аналогічними міркуваннями, як ми тоді шукали точку $v_1$}). Звідси $v - Tb_1 \in \overline{A\left(B\left( 0;\dfrac{1}{4} \right) \right)}$, тому існує точка $b_2 \in B\left(0;\dfrac{1}{4}\right)$, для якої $\| v - Ab_1 - Ab_2 \| < \dfrac{r}{8}$...\\
...
\[
\| b \| = \lim_{n \to \infty} \left\| \sum_{k=1}^n b_k \right\| \leq \lim_{n \to \infty} \sum_{k=1}^\infty \|b_k\| = \sum_{k=1}^\infty \|b_k\| \leq \sum_{k=1}^\infty 2^{-k} = 1.
\]
Однак $A$ --- обмежений оператор, тому неперервний, тож
\[
...
\[
\bigcup_{n \geq k} C_k = B[0;1].
\]
Такий розклад випливає з умови теореми. Оскільки $B[0;1]$ -- замкнений та $X$ -- банахів, то підпростір $B[0;1]$ теж буде повним. Тоді за теоремою Бера один із $C_k$ міститиме відкриту кулю $B(x_0;\delta_0)$.\\
