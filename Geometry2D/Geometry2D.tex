...
\begin{axiom}
\label{set_a_segment_with_length}
...
\begin{axiom}
\label{set_an_angle_with_degree}
...
\textcolor{red}{\textit{Надалі будуть наведені теореми, у деяких з яких їхні доведення будуть продемонстровані пізніше, коли опануємо певну теорію про трикутників. Я вирішив увесь фундамент планіметрії засунути в один розділ, а не розкидувати на різні розділи.}}
...
\textit{Доведення читати пізніше.}
\end{theorem}
...
\end{tikzpicture}
\end{figure}
Для початку ми створимо кут $\angle OMN$ (це можна зробити, бо ми проводимо $MO$). А далі відкладемо від променя $MN$ єдиний кут $O_1MN$ так, щоб $\angle OMN = \angle O_1MN$ за \axref{set_an_angle_with_degree}. Причому точку $O_1$ ми оберемо так, щоб $OM=O_1M$ за \axref{set_a_segment_with_length}.
\begin{figure}[H]
\centering
\begin{tikzpicture}
\draw (0,0)--(2,0);
...
\textit{Тепер можна повернутися до \thref{line_point_not_in_line_draw_perpendicular} та спокійно прочитати доведення.}
...
\textit{Тепер можна повернутися до \thref{perpendicular_bisector_and_equal_segments} та спокійно прочитати доведення.}
...
\begin{theorem}
Якщо катет дорівнює половині гіпотенузі, то протилежний до катета кут дорівнює $30^\circ$.\\
